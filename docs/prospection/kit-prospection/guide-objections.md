# Guide de traitement d'objections — Two-Step
...
**Ce qu'il pense vraiment** : "Encore un truc à gérer en plus de tout le reste."

**Réponse** :
> Je comprends totalement — c'est pour ça qu'on a conçu Two-Step pour zéro effort de votre part. Concrètement : je viens, je connecte votre caisse en 15 minutes, et ensuite vous ne touchez plus jamais à rien. Le stock se synchronise automatiquement. Pas de catalogue à remplir, pas de photos à prendre, pas de site à gérer. Vous continuez votre journée exactement comme avant.

**Si il insiste** :
> Et si on faisait ça un mardi matin, quand c'est calme ? 15 minutes et c'est fait pour toujours.

---

## 2. "Combien ça coûte ?" / "Ça va devenir payant"

**Ce qu'il pense vraiment** : "Je flaire l'arnaque du gratuit-puis-payant."
...
## 3. "J'ai déjà Instagram / Facebook / un site"
...
## 4. "Personne ne connaît votre app"
...
## 5. "Je n'ai pas de logiciel de caisse connecté"
...
## 6. "Je préfère attendre de voir si ça marche"

**Ce qu'il pense vraiment** : "Je ne veux pas essuyer les plâtres."

**Réponse** :
> Je comprends. Les 30 premiers marchands bénéficient de 1 mois gratuit et d'un tarif à 19€/mois verrouillé à vie. Les suivants paieront 29€, puis 39€. Plus vous venez tôt, moins vous payez — et ce tarif ne changera jamais.

**Formule Hormozi** :
> Le seul risque à attendre, c'est de payer 39€ demain ce qui est à 19€ aujourd'hui.

---

## 7. "Mon quartier n'est pas sur votre app"
...
## 8. "Les gens viennent chez moi pour le conseil, pas pour le produit"

**Ce qu'il pense vraiment** : "Mon métier, c'est la relation humaine, pas la tech."

**Réponse** :
> Absolument, et c'est votre force. Two-Step ne remplace pas le conseil — il amène des gens qui ont besoin de CE conseil chez vous. Aujourd'hui, ces gens-là achètent sur internet parce qu'ils ne savent pas que vous existez. Avec Two-Step, ils voient que vous avez le produit, ils viennent, et là c'est VOUS qui faites la différence avec votre expertise.

---

## 9. "J'ai déjà essayé des trucs comme ça, ça n'a pas marché"
...
## 10. "Envoyez-moi un email / de la doc"

**Ce qu'il pense vraiment** : "Je veux me débarrasser de vous poliment."

**Réponse** :
> Bien sûr ! C'est quoi votre adresse email ? Je vous envoie un résumé de 2 minutes + le lien vers notre site. Et si après lecture ça vous intéresse, on fait un appel de 5 minutes.

**Action** : envoyer immédiatement l'email avec le one-pager en lien + un message ultra-court. Relancer à J+3.

---

## Principes généraux

1. **Ne jamais contredire le commerçant.** Toujours commencer par "Je comprends" ou "Vous avez raison".
2. **Ramener à l'action concrète.** Chaque réponse doit finir par une proposition : RDV, appel, email.
3. **Utiliser des exemples concrets.** "Nike Air Max 42" est plus parlant que "vos produits".
4. **Le commerçant a raison de se méfier.** Notre boulot c'est de supprimer le risque, pas de le convaincre de prendre un risque.
5. **Un "non" aujourd'hui n'est pas un "non" pour toujours.** Noter le contact, relancer dans 3 mois avec des métriques.
