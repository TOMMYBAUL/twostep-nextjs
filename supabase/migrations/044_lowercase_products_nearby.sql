-- Fix case-sensitive category filter in get_products_nearby and get_products_nearby_count
-- Migration 035 fixed get_merchants_nearby but NOT these two RPCs
-- Also re-fix get_merchants_nearby which was overwritten by 034 without LOWER()
...
-- ─── get_merchants_nearby (re-apply LOWER fix lost in 034) ───
