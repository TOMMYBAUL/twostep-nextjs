...
function Marquee() {
    const base = "COMMERCE LOCAL  ·  STOCK VISIBLE  ·  TEMPS RÉEL  ·  TOULOUSE  ·  SANS LIVRAISON  ·  SANS E-COMMERCE  ·  ";
    return (
    ...
    const steps = [
        {
            ...
            desc: "Référence, marque, taille, quantité. En quelques minutes depuis votre téléphone. Sans logistique.",
            bg: "#EDE0C4", numColor: "rgba(44,32,24,0.1)", titleColor: "#2C2018", descColor: "#6B4F38",
        },
        {
            num: "02",
            title: "Un client cherche ce produit exact",
            desc: "Il tape la référence précise. Il voit votre boutique apparaître — avec la distance et le stock disponible.",
            bg: "#2C2018", numColor: "#C8813A", titleColor: "#F5EDD6", descColor: "rgba(245,237,214,0.6)",
        },
        {
            num: "03",
            title: "Il entre. Il achète.",
            desc: "Un client qui vient sait déjà ce qu'il veut. Vous le fidélisez — là où Amazon ne peut pas.",
