...
- Photos manquantes → cta: {"label": "Ajouter une photo", "href": "/dashboard/stock/mon-stock?filter=no-photo"}
...
- Stock à mettre à jour → cta: {"label": "Gérer le stock", "href": "/dashboard/stock/mon-stock"}
