            ...
            <div style={{ maxWidth: 800, margin: "0 auto", position: "relative", textAlign: "center" }}>
                ...
                <motion.div
                    ...
                    style={{
                        ...
                        background: "rgba(66,104,255,0.1)", border: "1px solid rgba(66,104,255,0.2)",
                        marginBottom: 40,
                    }}
                >
                    <div style={{ display: "flex", gap: 4, alignItems: "baseline" }}>
                        <span style={{ fontSize: 28, fontWeight: 900, color: "#4268FF", letterSpacing: "-0.03em", lineHeight: 1 }}>
                            <Counter to={pioneerCount} inView={inView} />
                        </span>
                        <span style={{ fontSize: 13, fontWeight: 600, color: "rgba(200,214,240,0.5)" }}>/30</span>
                    </div>
                    <div style={{ width: 1, height: 24, background: "rgba(200,214,240,0.1)" }} />
                    <div style={{ textAlign: "left" as const }}>
                        <div style={{ fontSize: 10, fontWeight: 700, color: "#FFFFFF", lineHeight: 1.2 }}>places prises</div>
                        ...
                        >
                            <SpotlightCard style={{
                                ...
                                <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
                                    ...
                                    >
                                        <item.Icon className="size-4" style={{ color: "#4268FF" }} />
                                    </motion.div>
