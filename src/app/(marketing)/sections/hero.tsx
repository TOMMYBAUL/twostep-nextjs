...
const heroCSS = `
.hero-s{min-height:100vh;background:#F5EDD6;display:flex;align-items:center;padding:100px 48px 80px;position:relative;overflow:hidden}
.hero-g{max-width:1200px;margin:0 auto;width:100%;display:grid;grid-template-columns:3fr 2fr;gap:64px;align-items:center}
.hero-h1{font-size:clamp(48px,5.5vw,80px);font-weight:800;line-height:1.1;letter-spacing:-0.035em;color:#2C2018;margin:0 0 24px}
...
.fc-n{top:16px!important;left:4px!important}
.fc-m{top:28%!important;right:4px!important}
.fc-d{bottom:16px!important;left:4px!important}
.fc-t{bottom:28%!important;right:4px!important}
}`;
